...
import { PdfContainer, Heading, BasicTitle, TableContainer, Table } from './pdfStyledComponents';
    ...
    <PdfContainer className="pdfContainer" id="pdfContainer">
      ...
      <div className="jobPdf_inputFiles">
        ...
        {input?.length > 0 ? (
          ...
          <div style={{ color: 'gray' }}> No input Files </div>
        )}
      </div>
      <div className="jobPdf_outputFiles">
        ...
        {output?.length > 0 ? (
          ...
          <div style={{ color: 'gray' }}> No output Files </div>
        )}
      </div>
    </PdfContainer>
  );
