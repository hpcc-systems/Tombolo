    ...
    <div className="ant-col ant-col-sm-24  ant-col-md-20 ant-col-xl-10">
      {!uploading ? (
        <>
          ...
          <div style={{ marginTop: '8px' }}>
            <p>{t('Destination Folder', { ns: 'fileUpload' })}</p>
            <Cascader
              options={options}
              loadData={loadData}
              allowClear
          ...
          <Dragger
            ...
            <p className="ant-upload-text">
              <b>{t('Click or drag files here to upload (Up to 5 files)', { ns: 'fileUpload' })}</b>
            </p>
            <p className="ant-upload-hint">{t('Supports xls, xlsm, xlsx, txt, json and csv', { ns: 'fileUpload' })}</p>
          </Dragger>
        </>
      ) : null}
      ...
      {!uploading ? (
        <Checkbox onChange={onCheckBoxChange} style={{ margin: '20px 0px 20px 0px' }}>
          {t('Overwrite File(s)', { ns: 'fileUpload' })}
        </Checkbox>
      ) : null}
