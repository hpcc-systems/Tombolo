        ...
        <div
          ...
          <Tabs defaultActiveKey="1" tabBarExtraContent={this.props.displayingInModal ? null : controls}>
                ...
                <Form
                    ...
                    <Row gutter={[8, 0]}>
                      <Col span={19}>
                        <AutoComplete
                          ...
                          placeholder={t('Search files', { ns: 'file' })}
                  ...
                  <Form.Item
                    ...
                    {!enableEdit ? (
                      ...
                      <Input
                        ...
                        placeholder={
                          enableEdit ? t('Name', { ns: 'common' }) : t('Name is not provided', { ns: 'file' })
                        }
                      />
                    )}
                  </Form.Item>
                  <Form.Item
                    ...
                    <Input
                      name="title"
                      placeholder={
                        enableEdit ? t('Title', { ns: 'common' }) : t('Title is not provided', { ns: 'file' })
                      }
                      disabled={!editingAllowed}
                      className={!enableEdit ? 'read-only-input' : ''}
                    />
                  ...
                  <Form.Item name="scope" label={t('Scope', { ns: 'common' })} rules={[{ required: enableEdit }]}>
                    <Input
                      ...
                      className={!enableEdit ? 'read-only-input' : ''}
                      placeholder={
                        enableEdit ? t('Scope', { ns: 'common' }) : t('Scope is not provided', { ns: 'file' })
                      }
                    />
                  </Form.Item>
                  <Form.Item
                    name="serviceURL"
                    label={t('Service URL', { ns: 'file' })}
                    className={enableEdit ? null : 'read-only-input'}
                    rules={[{ type: 'url', message: 'Please enter a valid URL' }]}>
                    <Input
                      disabled={!editingAllowed}
                      placeholder={
                        enableEdit ? t('Service URL', { ns: 'file' }) : t('Service URL is not provided', { ns: 'file' })
                      }
                    />
                  </Form.Item>
                  ...
                  <Form.Item
                    ...
                    <Input
                      disabled={!editingAllowed}
                      placeholder={enableEdit ? t('Path', { ns: 'common' }) : t('Path is not provided', { ns: 'file' })}
                    />
                  </Form.Item>
                  <Form.Item
                    label={t('Is Super File', { ns: 'file' })}
                    name="isSuperFile"
                  ...
                  <Form.Item
                    ...
                    {!enableEdit ? (
                      <Typography.Text disabled={!selectedSupplier} style={{ paddingLeft: '11px' }}>
                        {selectedSupplier || t('Supplier is not provided', { ns: 'file' })}
                      </Typography.Text>
                    ) : (
                      <Select
                        disabled={!editingAllowed}
                        ...
                        placeholder={
                          enableEdit
                            ? t('Select a supplier', { ns: 'file' })
                            : t('Supplier is not provided', { ns: 'file' })
                        }>
                  ...
                  <Form.Item
                    ...
                    {!enableEdit ? (
                      <Typography.Text disabled={!selectedConsumer} style={{ paddingLeft: '11px' }}>
                        {selectedConsumer || t('Consumer is not provided', { ns: 'file' })}
                      </Typography.Text>
                    ) : (
                      <Select
                        disabled={!editingAllowed}
                        ...
                        placeholder={
                          enableEdit
                            ? t('Select a consumer', { ns: 'file' })
                            : t('Consumer is not provided', { ns: 'file' })
                        }>
                  ...
                  <Form.Item
                    ...
                    {!enableEdit ? (
                      <Typography.Text disabled={!selectedOwner} style={{ paddingLeft: '11px' }}>
                        {selectedOwner || t('Owner is not provided', { ns: 'file' })}
                      </Typography.Text>
                    ) : (
                      <Select
                        disabled={!editingAllowed}
                        ...
                        placeholder={
                          enableEdit ? t('Select a owner', { ns: 'file' }) : t('Owner is not provided', { ns: 'file' })
                        }>
                        {owners.map((owner) => (
            ...
            {VIEW_DATA_PERMISSION && showFilePreview ? (
              <TabPane tab={t('File Preview', { ns: 'file' })} key="6">
                <Table
                  size="small"
                  pagination={false}
                  scroll={{ y: '400px' }}
...
FileDetailsForm = withTranslation(['common', 'file'])(FileDetailsForm);
