...
function Clusters() {
  ...
  const clusterTableColumns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <span>
          <Tooltip placement="right" title={t('Edit Cluster', { ns: 'clusters' })}>
          ...
          <Popconfirm
            ...
            <Tooltip placement="right" title={t('Delete Cluster', { ns: 'clusters' })}>
              <DeleteOutlined />
            </Tooltip>
          </Popconfirm>
          <Divider type="vertical" />
    ...
    <>
      ...
      <Modal
        ...
        <Form layout="vertical" form={form}>
          <Form.Item label={t('Host', { ns: 'clusters' })} name="name" required>
            <Select placeholder={t('Select a Cluster', { ns: 'clusters' })}>
