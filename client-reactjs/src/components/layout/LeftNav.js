      ...
      >
          ...
          <div className="sidebar-sticky">
            <ul className="nav flex-column">
              ...
              <li className="nav-item" >
                <NavLink to={"/"+applicationId+"/jobs"} className="nav-link" data-toggle="popover" tabIndex="4"><i className="fa fa-lg fa-clock-o"></i> <span className={this.state.collapsed ? "d-none" : ""}>Workflow</span></NavLink>
              </li>
              {/*<li className="nav-item">
