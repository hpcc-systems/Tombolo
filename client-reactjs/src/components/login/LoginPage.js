...
class LoginPage extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      nextProps.newUserRegistering &&
      nextProps.userRegistrationSuccess != undefined &&
    ...
    if (
      ...
      if (nextProps.status == 201) {
        ...
        message.info(
          'It looks like an account already exists for you. If you already registered for RealBI application, please login to Tombolo using your RealBI account.'
        );
      }
      setTimeout(() => {
        this.handleBack();
        ...
        {loginView ? (
          ...
          <Form className="login-form" labelAlign="left" {...formItemLayout}>
            ...
            {userRegistrationError && (
              <Form.Item>
                <Alert message="Error" description="Failed to register user." type="error" showIcon />
              </Form.Item>
            )}
            <Form.Item {...tailFormItemLayout}>
