...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('work_unit_details', {
      ...
      NumAvgDiskRowsRead: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      NumMinDiskRowsRead: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      NumMaxDiskRowsRead: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      ...
      SizeStdDevDiskRead: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      ...
      SizeStdDevDiskWrite: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      ...
      PeakAvgMemoryUsage: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      PeakMinMemoryUsage: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      PeakMaxMemoryUsage: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      ...
      SpillAvgRowsWritten: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      SpillMinRowsWritten: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      SpillMaxRowsWritten: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      SpillSizeWritten: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      SpillAvgSizeWritten: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      SpillMinSizeWritten: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      SpillMaxSizeWritten: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      ...
      NumAvgRowsProcessed: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      NumMinRowsProcessed: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      NumMaxRowsProcessed: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      ...
      SizeAvgNetworkWrite: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      SizeMinNetworkWrite: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      SizeMaxNetworkWrite: { type: Sequelize.BIGINT.UNSIGNED, allowNull: true },
      ...
      NodeMinDiskReadIO: { type: Sequelize.TINYINT.UNSIGNED, allowNull: true },
      NodeMaxDiskReadIO: { type: Sequelize.TINYINT.UNSIGNED, allowNull: true },
      NodeMinDiskWriteIO: { type: Sequelize.TINYINT.UNSIGNED, allowNull: true },
      NodeMaxDiskWriteIO: { type: Sequelize.TINYINT.UNSIGNED, allowNull: true },
