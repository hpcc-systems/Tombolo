    ...
    return queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          description:
            'Nonpublic personal information including an individual’s name, address, telephone number, social security number, photograph, and medical or disability information',
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          description:
            "Nonpublic personal information including an individual's name, address, telephone number, social security number, income, credit score",
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
