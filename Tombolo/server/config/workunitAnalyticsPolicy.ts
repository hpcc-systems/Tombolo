...
export const SCOPEABLE_WORKUNIT_ANALYTICS_TABLES =
  ALLOWED_WORKUNIT_ANALYTICS_TABLES.filter(table => table !== 'clusters');

export const SCOPEABLE_WORKUNIT_ANALYTICS_TABLE_SET = new Set(
