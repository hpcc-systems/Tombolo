module.exports = (sequelize, DataTypes) => {
  const dataflow_cluster_credentials = sequelize.define(
    'dataflow_cluster_credentials',
    {
      id: {
        primaryKey: true,
        type: DataTypes.UUID,
  ...
  dataflow_cluster_credentials.associate = function (models) {
    dataflow_cluster_credentials.belongsTo(models.dataflow, {
      foreignKey: 'dataflow_id',
    });
    dataflow_cluster_credentials.belongsTo(models.Cluster, {
