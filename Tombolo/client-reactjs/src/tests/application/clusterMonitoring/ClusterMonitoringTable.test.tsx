...
describe('ClusterMonitoringTable', () => {
  ...
  it('shows error when starting non-approved; toggles when approved; shows success message', async () => {
    ...
    const { rerender } = render(
      <ClusterMonitoringTable
        clusterMonitoring={[rowPending] as ClusterMonitoringDTO[]}
        applicationId={'app-1'}
    ...
    rerender(
      <ClusterMonitoringTable
        clusterMonitoring={[rowApproved] as ClusterMonitoringDTO[]}
        applicationId={'app-1'}
        setSelectedMonitoring={vi.fn()}
        isReader={false}
        setDisplayViewDetailsModal={vi.fn()}
    ...
    mockToggleSingle.mockResolvedValueOnce(undefined);
  ...
  it('allows row selection to set selected rows', async () => {
    ...
    render(
      <ClusterMonitoringTable
        clusterMonitoring={[rowApproved] as any}
        applicationId={'app-1'}
        setSelectedMonitoring={vi.fn()}
        isReader={false}
        setDisplayViewDetailsModal={vi.fn()}
