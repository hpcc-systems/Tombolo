...
vi.mock('antd', async importOriginal => {
  ...
  return { ...(antd as any), Form: MockForm, Row: MockRow, Col: MockCol, Select: MockSelect, Input: MockInput };
});
...
vi.mock('@/components/common/Monitoring/AsrSpecificFilters', () => ({
  default: props => {
    lastAsrProps = props;
...
describe('MonitoringFilters', () => {
  ...
  it('renders base fields and options; search suffix logic and lowercasing on change', async () => {
    ...
    expect((suffix2.firstChild as HTMLElement).style.color).toBe('var(--primary)');
