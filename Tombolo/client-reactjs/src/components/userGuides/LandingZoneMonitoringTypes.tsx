...
const LandingZoneMonitoringTypes: React.FC = () => (
  <div className="guide">
    ...
    <p>
      <span>Note:</span> This monitoring type is only available for <span>bare metal clusters</span>. It is disabled for
      containerized clusters due to architectural differences in how storage is managed.
    </p>
