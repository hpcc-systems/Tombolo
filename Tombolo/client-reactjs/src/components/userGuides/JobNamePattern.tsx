...
const JobNamePattern: React.FC = () => (
  <div className="guide">
    ...
    <div className="appendix">
      ...
      <h3>&lt;DATE&gt;</h3>
      <p>
        This will be replaced by the current date, in YYYYMMDD format. For example, if &quot;Launch &lt;DATE&gt; Current
        Carrier&quot; is specified, the system will replace &lt;DATE&gt; with the current date. If today&apos;s date is
        Mar 16th, 2021, the replaced value will be &quot;Launch 20210316 Current Carrier&quot;.
      </p>

      <h3>&lt;DATE,ADJUSTMENT,FORMAT&gt;</h3>
      <p>
        This will be replaced by the current date adjusted by the number of days specified in the &quot;ADJUSTMENT&quot;
        option, as per the format specified in the &quot;FORMAT&quot; option.
      </p>
      ...
      <p>
        For example, if &quot;Launch &lt;DATE,1,%Y_%m_%d&gt; Alirts Despray&quot; is specified, the system will replace
        &lt;DATE&gt; with the current date and adjust by the number of days and format as specified. If today&apos;s
        date is Mar 16th, 2021, the replaced value will be &quot;Launch 20210317 Alirts Despray&quot;.
      </p>
    </div>
