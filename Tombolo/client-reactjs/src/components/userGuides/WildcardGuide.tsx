...
const WildcardGuide: React.FC = () => (
  <div className="guide">
    ...
    <p>
      ...
      locating multiple items with similar, but not identical data. Wildcards can also help with getting data based on a
      specified pattern match. For example, finding everyone named John on Park Street.
    </p>
    <br />
    <p>
