...
const SCHEMA_STRUCTURE = [
  {
    title: 'work_unit_details',
    key: 'work_unit_details',
    icon: <TableOutlined />,
    children: [
      {
        title: 'wuId',
        key: 'wuId',
        type: 'string',
        description: 'Workunit identifier',
        isLeaf: true,
      },
      {
        title: 'clusterId',
      ...
      },
      {
        ...
        key: 'state',
        type: 'string',
        description: 'Workunit state (completed, failed, running, etc.)',
        isLeaf: true,
      },
      {
        title: 'owner',
      ...
      {
        title: 'workUnitTimestamp',
        key: 'workUnitTimestamp',
        type: 'timestamp',
        description: 'When workunit was submitted',
        isLeaf: true,
      },
      {
        title: 'totalCostms',
      ...
      },
      {
        ...
        key: 'compileCostms',
        type: 'bigint',
        description: 'Compile time in milliseconds',
        isLeaf: true,
      },
      {
        title: 'executeCostms',
      ...
      },
      {
        ...
        key: 'scopeType',
        type: 'string',
        description: 'Type of scope (graph, subgraph, activity)',
        isLeaf: true,
      },
      {
        title: 'timeLocalExecuteMs',
        key: 'timeLocalExecuteMs',
        type: 'bigint',
        description: 'Local execution time for this scope',
        isLeaf: true,
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        key: 'wuid',
        type: 'string',
        description: 'Workunit unique identifier',
        isLeaf: true,
      },
      {
        title: 'name',
      ...
      },
      {
        ...
        key: 'cluster_id',
        type: 'string',
        description: 'Cluster ID (foreign key)',
        isLeaf: true,
      },
      {
        title: 'jobname',
    ...
    children: [
      {
        ...
        key: 'cluster_id',
        type: 'string',
        description: 'Cluster ID (primary key)',
        isLeaf: true,
      },
      {
        title: 'name',
        key: 'cluster_name',
        type: 'string',
        description: 'Cluster name (use this for readable cluster names)',
        isLeaf: true,
      },
      {
        title: 'thor',
        key: 'thor',
        type: 'string',
        description: 'Thor cluster address',
        isLeaf: true,
      },
      {
        title: 'roxie',
        key: 'roxie',
        type: 'string',
        description: 'Roxie cluster address',
        isLeaf: true,
      },
      {
        title: 'username',
