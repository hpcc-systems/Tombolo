...
// import { Button, Divider, notification, Popconfirm, Spin, Table, Tooltip } from 'antd';
...
//         render: (text, record) => (
//           <span>
//             <a onClick={(_row) => this.handleEdit(record.compliance)}>
...
//               onConfirm={() => this.handleDelete(record.compliance)}
