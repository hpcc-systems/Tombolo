export const Constants = {
  ...
  DATE_FORMAT_OPTIONS: { year: 'numeric', month: 'long', day: 'numeric' } as Intl.DateTimeFormatOptions,
  COMPACT_DATE_FORMAT_OPTIONS: { year: 'numeric', month: 'numeric', day: 'numeric' } as Intl.DateTimeFormatOptions,
  TIME_FORMAT_OPTIONS: { hour: '2-digit', minute: '2-digit' } as Intl.DateTimeFormatOptions,
