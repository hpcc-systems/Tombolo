...
import { Modal, Tabs, Button, Badge, FormInstance } from 'antd';
...
interface AddEditCostMonitoringModalProps {
  displayAddCostMonitoringModal: boolean;
  handleSaveCostMonitoring: () => Promise<void>;
  handleUpdateCostMonitoring: () => Promise<void>;
  form: FormInstance;
  clusters: Cluster[];
  savingCostMonitoring: boolean;
  isEditing: boolean;
...
const AddEditCostMonitoringModal = ({
  ...
  selectedClusters,
  setSelectedDomain,
}: AddEditCostMonitoringModalProps) => {
