...
interface Props {
  ...
  intermittentScheduling: { frequency?: string };
}

const JobMonitoringNotificationTab: React.FC<Props> = ({ form, intermittentScheduling }) => {
  const [jobStatuses, setJobStatuses] = useState<typeof BASE_JOB_STATUSES>([]);
