...
const modalSize = { width: 900, height: 460 };
...
const GraphExpanded: React.FC<Props> = ({ setViewExpandedGraph, clusterUsageHistory }) => {
  return (
    <div className={styles.graphExpanded_main}>
      <div className={styles.graphExpanded_content} onClick={e => e.stopPropagation()}>
        <Resizable
          ...
          defaultSize={{ width: modalSize.width, height: modalSize.height }}>
          <div>
