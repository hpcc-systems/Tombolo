...
interface FileMonitoringNotificationTabProps {
  form: FormInstance;
  ...
  setMinSizeThresholdUnit: (unit: string) => void;
  setMaxSizeThresholdUnit: (unit: string) => void;
  minSizeThresholdUnit: string;
  maxSizeThresholdUnit: string;
}
...
function FileMonitoringNotificationTab({
...
}: FileMonitoringNotificationTabProps) {
  ...
  }, [monitoringFileType, form, isEditing, isDuplicating]);

  // Handle Threshold Unit Change, re calulate and set error if min is greater than max and vice versa
  const handleThresholdUnitChange = (value: string, field: 'minThreshold' | 'maxThreshold') => {
  ...
  // Threshold Addons
  const renderThresholdAddon = (field: 'minThreshold' | 'maxThreshold') => (
    ...
    <Form form={form} layout="vertical">
      <NotificationContacts>
        <Form.Item
          ...
          <Select mode="multiple" placeholder="Select one" onChange={value => setSelectedNotificationCondition(value)}>
