...
const activityKindLabels = [
  ...
  'Disk Aggregate',
  'Disk Count',
  'Disk Grouped Aggregate',
  'Disk Exists',
  'Index Read',
  'Index Normalize',
  'Index Aggregate',
  'Index Count',
  'Index Grouped Aggregate',
  'Index Exists',
  'Child Read',
  'Child Normalize',
  'Child Aggregate',
  'Child Count',
  'Child Grouped Aggregate',
  'Child Exists',
  'Skip Limit',
  'Normalize',
  'Csv Read',
  ...
  'All Denormalize',
  'Smart Denormalize',
  'Unknown Denormalize1',
  'Unknown Denormalize2',
  'Unknown Denormalize3',
  'Last Denormalize',
  'Denormalize Group',
  'Hash Denormalize Group',
  'Lookup Denormalize Group',
  'Self Denormalize Group',
  'Keyed Denormalize Group',
  'All Denormalize Group',
  'Smart Denormalize Group',
  'Unknown Denormalize Group1',
  'Unknown Denormalize Group2',
  'Unknown Denormalize Group3',
  'Last Denormalize Group',
  'Json Write',
  'Json Read',
  'Trace',
  'Quantile',
  ...
  'Nway Distribute',
  'Disk Read',
  'Unknown', // TAKlast has no getActivityText case
] as const;
